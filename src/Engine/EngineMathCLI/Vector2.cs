...
namespace EngineMathCLI
{
    ...
    {
        public static Vector2 Polar(this Vector2 v, double angulo, float distancia)
        {
            float anguloRadiano = MathHelper.ToRadians((float)angulo);
            float x, y;
        ...
        public static Vector2 Reset(this Vector2 value)
        {
            value.X = 0;
            value.Y = 0;
        ...
        public static Vector2 ConvertToSignedRange(this Vector2 value)
        {
        ...
        public static Vector2 ConvertToUnsignedRange(this Vector2 value)
        {
            Vector2 retValue = Vector2.Zero;
        ...
        public static float[] ConvertVector2ListToFloatList(this List<Vector2> vertices)
        {
            float[] v = new float[vertices.Count * 2];
        ...
        //converte uma lista de vector3 para uma lista de floats
        public static float[] ConvertVector2ToFloatList(this Vector2 vertices)
        {
            float[] v = new float[2];
            v[0] = vertices.X;
            v[1] = vertices.Y;
