...
namespace EngineMathCLI
{
    public struct Ray : IEquatable<Ray>
    {
        ...
        public Ray(Vector3 position, Vector3 direction, int level = 0)
        {
            this.Level = level;
        ...
        //pega o segmento de reta do mouse 
        public static Ray GetPickRay(int mouseX, int mouseY, Matrix projection, Matrix view,
                                    int viewPortWidth, int viewPortHeight, float near, float far)
        {
            ...
            Vector3 nearPoint = Matrix.Unproject(nearsource, projection, view, world, viewPortWidth, viewPortHeight, near, far);
            Vector3 farPoint = Matrix.Unproject(farsource, projection, view, world, viewPortWidth, viewPortHeight, near, far);
