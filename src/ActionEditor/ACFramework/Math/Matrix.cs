...
namespace ACFramework
{
    public struct Matrix : IEquatable<Matrix>
    {
        ...
        public static Matrix CreateFromString(string matrix)
        {
            matrix = matrix.Replace("{", string.Empty);
            matrix = matrix.Replace("}", string.Empty);

            matrix = matrix.Replace("M11:", string.Empty);
            matrix = matrix.Replace("M12:", string.Empty);
            matrix = matrix.Replace("M13:", string.Empty);
            matrix = matrix.Replace("M14:", string.Empty);

            matrix = matrix.Replace("M21:", string.Empty);
            matrix = matrix.Replace("M22:", string.Empty);
            matrix = matrix.Replace("M23:", string.Empty);
            matrix = matrix.Replace("M24:", string.Empty);

            matrix = matrix.Replace("M31:", string.Empty);
            matrix = matrix.Replace("M32:", string.Empty);
            matrix = matrix.Replace("M33:", string.Empty);
            matrix = matrix.Replace("M34:", string.Empty);

            matrix = matrix.Replace("M41:", string.Empty);
            matrix = matrix.Replace("M42:", string.Empty);
            matrix = matrix.Replace("M43:", string.Empty);
            matrix = matrix.Replace("M44:", string.Empty);

            string[] separator = { " " };
            string[] matrixValues = matrix.Split(separator, StringSplitOptions.RemoveEmptyEntries);

            Matrix matrix4 = new Matrix(float.Parse(matrixValues[0], CultureInfo.InvariantCulture),
        ...
        public static Matrix CreateShadow(Vector3 lightDirection, Plane3D plane)
        {
            Matrix matrix;
            Plane3D plane2;
            Plane3D.Normalize(ref plane, out plane2);
        ...
        public static void CreateShadow(ref Vector3 lightDirection, ref Plane3D plane, out Matrix result)
        {
            Plane3D plane2;
            Plane3D.Normalize(ref plane, out plane2);
            float num = ((plane2.Normal.X * lightDirection.X) + (plane2.Normal.Y * lightDirection.Y)) + (plane2.Normal.Z * lightDirection.Z);
        ...
        public static Matrix CreateReflection(Plane3D value)
        {
            Matrix matrix;
            value.Normalize();
        ...
        public static void CreateReflection(ref Plane3D value, out Matrix result)
        {
            Plane3D plane;
            Plane3D.Normalize(ref value, out plane);
            value.Normalize();
        ...
        public override string ToString()
        {
            ...
            return ("{ " + string.Format(currentCulture, "{{M11:{0} M12:{1} M13:{2} M14:{3}}} ",
                            new object[] { this.M11.ToString(currentCulture), 
                          ...
                          + string.Format(currentCulture, "{{M21:{0} M22:{1} M23:{2} M24:{3}}} ",
                            new object[] { this.M21.ToString(currentCulture), 
                          ...
                          + string.Format(currentCulture, "{{M31:{0} M32:{1} M33:{2} M34:{3}}} ",
                            new object[] { this.M31.ToString(currentCulture), 
                          ...
                          + string.Format(currentCulture, "{{M41:{0} M42:{1} M43:{2} M44:{3}}} ",
                            new object[] { this.M41.ToString(currentCulture), 
                                 ...
                                 int viewPortWidth, int viewPortHeight, float near, float far)
        {
            ...
            source.X = (((source.X - X) / ((float)viewPortWidth)) * 2f) - 1f;
            source.Y = -((((source.Y - Y) / ((float)viewPortHeight)) * 2f) - 1f);
        ...
        public static Vector3 Project(Vector3 source, Matrix projection, Matrix view, Matrix world,
                               int viewPortWidth, int viewPortHeight, float near, float far)
        {
            ...
            vector.X = (((vector.X + 1f) * 0.5f) * viewPortWidth) + X;
            vector.Y = (((-vector.Y + 1f) * 0.5f) * viewPortHeight) + Y;
        ...
        public const string MATRIX_ROOT_NODE = "MATRIX";

        public const string M11_ATTRIB = "M11";
        public const string M12_ATTRIB = "M12";
        public const string M13_ATTRIB = "M13";
        public const string M14_ATTRIB = "M14";
        public const string M21_ATTRIB = "M21";
        public const string M22_ATTRIB = "M22";
        public const string M23_ATTRIB = "M23";
        public const string M24_ATTRIB = "M24";
        public const string M31_ATTRIB = "M31";
        public const string M32_ATTRIB = "M32";
        public const string M33_ATTRIB = "M33";
        public const string M34_ATTRIB = "M34";
        public const string M41_ATTRIB = "M41";
        public const string M42_ATTRIB = "M42";
        public const string M43_ATTRIB = "M43";
        public const string M44_ATTRIB = "M44";
    ...
    {
        //converte uma lista de vector3 para uma lista de floats
        public static float[,] ConvertMatrixToFloatList(this Matrix matrix)
        {
