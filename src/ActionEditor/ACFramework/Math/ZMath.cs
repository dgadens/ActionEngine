...
namespace ACFramework
{
    public class ZMath
    {
        ...
        public static Vector3 ClosestPtPointPlane(Vector3 q, Plane3D p)
        {
        ...
        public static float DistPointPlane(Vector3 q, Plane3D p)
        {
        ...
        public static bool IntersectSegmentPlane(Vector3 a, Vector3 b, Plane3D p, ref float t, ref Vector3 q)
        {
        ...
        public static bool IntersectSegmentPolyhedron(Vector3 a, Vector3 b, Plane3D[] p, int n,
        ...
        public static bool TestPointPolyhedron(Vector3 p, Plane3D[] planes)
        {
        ...
        public static bool IntersectPlanes(Plane3D p1, Plane3D p2, ref Vector3 p, ref Vector3 d)
        {
        ...
        public static bool IntersectPlanes(Plane3D p1, Plane3D p2, Plane3D p3, ref Vector3 p)
        {
        ...
        public static bool IntersectMovingSpherePlane(BoundingSphere s, Vector3 v,
                                                        Plane3D p, ref float t, ref Vector3 q)
        {
        ...
        public static bool TestMovingSpherePlane(Vector3 a, Vector3 b, float r, Plane3D p)
        {
