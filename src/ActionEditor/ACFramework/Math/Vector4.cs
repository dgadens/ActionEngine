...
namespace ACFramework
{
    ...
    public static class Vector4Extensions
    {
        ...
        public static Vector4 ConvertToSignedRange(this Vector4 value)
        {
            Vector4 retValue = Vector4.Zero;
            retValue.X = 2 * (value.X - 0.5f);
            retValue.Y = 2 * (value.Y - 0.5f);
            retValue.Z = 2 * (value.Z - 0.5f);
            retValue.W = 2 * (value.W - 0.5f);
            return retValue;
        }

        //converte do intervalo 0 1 para -1 1
        public static Vector4 ConvertToUnsignedRange(this Vector4 value)
        {
            Vector4 retValue = Vector4.Zero;
            retValue.X = 0.5f * value.X + 0.5f;
            retValue.Y = 0.5f * value.Y + 0.5f;
            retValue.Z = 0.5f * value.Z + 0.5f;
            retValue.W = 0.5f * value.W + 0.5f;
            return retValue;
        }

        //converte uma lista de vector3 para uma lista de floats
        public static float[] ConvertVector4ListToFloatList(this List<Vector4> vertices)
        {
            float[] v = new float[vertices.Count * 4];
        ...
        //converte uma lista de vector3 para uma lista de floats
        public static float[] ConvertVector4ToFloatList(this Vector4 vertices)
        {
            float[] v = new float[4];
            v[0] = vertices.X;
            v[1] = vertices.Y;
