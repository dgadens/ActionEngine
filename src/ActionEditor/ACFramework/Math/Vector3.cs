...
namespace ACFramework
{
    public struct Vector3 : IEquatable<Vector3>
    {
        ...
        public bool Near(Vector3 other)
        {
            ...
            return ((((this.X >= other.X - smallValue) && (this.X <= other.X + smallValue)) &&
                ((this.Y >= other.Y - smallValue) && (this.Y <= other.Y + smallValue))) &&
                ((this.Z >= other.Z - smallValue) && (this.Z <= other.Z + smallValue)));
        }

        public bool Near(Vector3 other, float smallValue)
        {
            return ((((this.X >= other.X - smallValue) && (this.X <= other.X + smallValue)) &&
                ((this.Y >= other.Y - smallValue) && (this.Y <= other.Y + smallValue))) &&
                ((this.Z >= other.Z - smallValue) && (this.Z <= other.Z + smallValue)));
    ...
    {
        public static Vector3 Reset(this Vector3 value)
        {
            value.X = 0;
            value.Y = 0;
            value.Z = 0;
        ...
        //converte do intervalo -1 1 para 0 1
        public static Vector3 ConvertToSignedRange(this Vector3 value)
        {
            Vector3 retValue = new Vector3(0);
            retValue.X = 2 * (value.X - 0.5f);
            retValue.Y = 2 * (value.Y - 0.5f);
            retValue.Z = 2 * (value.Z - 0.5f);
            return retValue;
        }

        //converte do intervalo 0 1 para -1 1
        public static Vector3 ConvertToUnsignedRange(this Vector3 value)
        {
            Vector3 retValue = new Vector3(0);
            retValue.X = 0.5f * value.X + 0.5f;
            retValue.Y = 0.5f * value.Y + 0.5f;
            retValue.Z = 0.5f * value.Z + 0.5f;
            return retValue;
        }

        //converte uma lista de vector3 para uma lista de floats
        public static float[] ConvertVector3ListToFloatList(this List<Vector3> vertices)
        {
            float[] v = new float[vertices.Count * 3];
        ...
        //converte uma lista de vector3 para uma lista de floats
        public static float[] ConvertVector3ToFloatList(this Vector3 vertices)
        {
            float[] v = new float[3];
            v[0] = vertices.X;
            v[1] = vertices.Y;
